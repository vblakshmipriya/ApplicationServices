...
public class Mongo2gsonUtil {
    ...
    public Mongo2gsonUtil() {
        Mongo2gsonUtil.dateFormat  = defaultDateFormat;
    }

    public Mongo2gsonUtil(DateFormat dateFormat) {
        Mongo2gsonUtil.dateFormat = dateFormat;
    }
