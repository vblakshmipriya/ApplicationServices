...
import com.comcast.technucleus.application.exception.FallBackException;
...
public class EnterpriseInventoryServiceRouterImpl implements EnterpriseInventoryServiceRouter 
{
	...
	@HystrixCommand(groupKey="maestro", commandKey ="getEISTechBuffer", fallbackMethod="getEISTechBufferFallBack",
			commandProperties={ 
	...
	/**
	 * Method Name : getEISTechBufferFallBack
	 * Description :  This method will invoke from Hystrix if there is any error while calling getTechnicianBuffer method
	 * 
	 * @param  String 			ntID 
	 * @return Eisresultset 
	 */
	...
	{	
		log.error("getEISTechBufferFallBack: error while reteriving TechBuffer Error",FallBackErrorCode.FALL_BACK_EIS_TECH_BUFFER.toString() );
		throw new FallBackException("getEISTechBufferFallBack - Error retrieving reteriving TechBuffer",
				FallBackErrorCode.FALL_BACK_EIS_TECH_BUFFER.toString());	
	}	
}
